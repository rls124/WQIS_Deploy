...
var features_sampleData_1 = format_sampleData_1.readFeatures(json_sampleData_1, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_sampleData_1 = new ol.source.Vector({
    attributions: '<a href=""></a>',
});
jsonSource_sampleData_1.addFeatures(features_sampleData_1);var lyr_sampleData_1 = new ol.layer.Vector({
                declutter: true,
...
lyr_OpenStreetMap_0.setVisible(true);lyr_sampleData_1.setVisible(true);
