		   ...
		   <h1>Water Quality Parameters</h1>
            ...
            <div class="card">
                <div class="card-header" role="tab" id="headingTwo">
                    <h3 class="heading mb-0">
                        <a class="collapsed" data-toggle="collapse" data-parent="#accordian" href="#collapseTwo">Bridge to Water Height</a>
                    </h3>
                </div>
                <div id="collapseTwo" class="collapse" role="tabpanel" aria-labelledby="headingTwo">
                    <div class="card-block">
                        <p>Bridge to Water Height is measuring the distance between the surface of the water and the bridge at which the water sampling is done. Measuring this distance provides a way to keep track of the overall stream height, which is likely to increase with high volumes of rain. The overall height of the stream or river can have an impact on various other physical properties of the water.</p>
                    </div>
                </div>
            </div>
			<!-- 3 -->
            ...
            <div class="card">
                <div class="card-header" role="tab" id="headingSix">
                    <h3 class="heading mb-0">
                        <a class="collapsed" data-toggle="collapse" data-parent="#accordian" href="#collapseSix">Nitrate and Nitrite</a>
                    </h3>
                </div>
                <div id="collapseSix" class="collapse" role="tabpanel" aria-labelledby="headingSix">
                    <div class="card-block">
                        <p>Nitrite is toxic to aquatic life and humans if consumed in excessive amounts.  Nitrite is commonly found in streams and rivers only in trace amounts because it is quickly oxidized to nitrate.  Nitrate is a plant nutrient at low concentrations, but can be toxic to aquatic life at higher levels.  Nitrite and nitrate can be introduced in excessive amounts from sewage treatment plants, combined sewage overflow, farm field runoff, animal feed lot runoff, and faulty septic systems.  The MCL for nitrate in drinking water is 10 mg/L. The USEPA reference concentration for nitrates + nitrites in streams and rivers in our Ecoregion is 1.6 mg/L.</p>
                    </div>
                </div>
            </div>
			<!-- 7 -->
            <div class="card">
                <div class="card-header" role="tab" id="headingSeven">
                    <h3 class="heading mb-0">
                        <a class="collapsed" data-toggle="collapse" data-parent="#accordian" href="#collapseSeven">pH</a>
                    </h3>
                </div>
                <div id="collapseSeven" class="collapse" role="tabpanel" aria-labelledby="headingSeven">
                    <div class="card-block">
                        <p>pH is an important factor in the health of a water system.  If a stream is too acidic or basic it will affect the biological function of aquatic organisms.  pH can also change the waters chemistry.  For example, a higher pH means that a smaller amount of ammonia in the water may make it harmful to aquatic organisms and a lower pH may increase the amount of metal present in the water.  Pollution, such as acidic precipitation and mine drainage can change a water's pH, which in turn can harm animals and plants living in the water. For instance, water coming out of an abandoned coal mine can have a pH of 2, which is very acidic and would result in significant mortality of aquatic organisms. Because a healthy stream typically has a pH between 6 and 9, the State of Indiana uses this range as its high-quality benchmark.</p>
                    </div>
                </div>
            </div>
			<!-- 8 -->
            <div class="card">
                <div class="card-header" role="tab" id="headingEight">
                    <h3 class="heading mb-0">
                        <a class="collapsed" data-toggle="collapse" data-parent="#accordian" href="#collapseEight">Specific conductance</a>
                    </h3>
                </div>
                <div id="collapseEight" class="collapse" role="tabpanel" aria-labelledby="headingEight">
                    <div class="card-block">
                        <p>Specific conductance is a measure of the ability of water to conduct an electrical current.  The presence of inorganic dissolved solids such as chloride, nitrate, sulfate, phosphate, sodium, magnesium, calcium, increase the conductance of water. Although conductivity in most streams and rivers is affected primarily by the geology of the area, discharges to streams can change the conductivity depending on their make-up. A failing sewage system would raise the conductivity because of the presence of chloride, phosphate, and nitrate; an oil spill would lower the conductivity. Conductivity is measured in microsiemens per centimeter (mS/cm).  The conductivity of rivers in the United States generally ranges from 50 to 1500 mS/cm.  Studies of inland fresh waters indicate that streams supporting good mixed fisheries have a range between 150 and 500 mS/cm. Conductivity outside this range could indicate that the water is not suitable for aquatic life.</p>
                    </div>
                </div>
            </div>
			<!-- 9 -->
            ...
            <div class="card">
                <div class="card-header" role="tab" id="headingTwelve">
                    <h3 class="heading mb-0">
                        <a data-toggle="collapse" data-parent="#accordian" href="#collapseTwelve" aria-expanded="true">Water temperature</a>
                    </h3>
                </div>
                <div id="collapseTwelve" class="collapse" role="tabpanel" aria-labelledby="headingTwelve">
                    <div class="card-block">
                        <p>Water temperature can affect many aspects of the health of the water system, but is an important controlling factor for aquatic organisms.  Temperature also can affect the ability of water to hold oxygen as well as the ability of organisms to resist certain pollutants.  If there are too many swings in water temperature, metabolic activities of aquatic organisms may slow, speed up, or even stop.  Many things can affect water temperature, including stream canopy, dams, and industrial discharges.  The state of Indiana has set a standard for water temperature depending on if the waterbody is a cold or warm water system. Since water bodies in the St. Joseph River Watershed are classified as warm water systems, the maximum temperature should not exceed 29 degrees C.</p>
                    </div>
                </div>
            </div>
