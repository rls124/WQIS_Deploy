           ...
           <h1>Water Quality Parameters</h1>
            ...
            <div class="card">
                <div class="card-header" role="tab" id="headingTwo">
                    <h3 class="heading mb-0">
                        <a class="collapsed" data-toggle="collapse" data-parent="#accordian" href="#collapseTwo">Dissolved oxygen</a>
                    </h3>
                </div>
            ...
            <div class="card">
                <div class="card-header" role="tab" id="headingThree">
                    <h3 class="heading mb-0">
                        <a class="collapsed" data-toggle="collapse" data-parent="#accordian" href="#collapseThree">pH</a>
                    </h3>
                </div>
            ...
            <div class="card">
                <div class="card-header" role="tab" id="headingFour">
                    <h3 class="heading mb-0">
                        <a class="collapsed" data-toggle="collapse" data-parent="#accordian" href="#collapseFour">Total dissolved solids</a>
                    </h3>
                </div>
            ...
            <div class="card">
                <div class="card-header" role="tab" id="headingFive">
                    <h3 class="heading mb-0">
                        <a class="collapsed" data-toggle="collapse" data-parent="#accordian" href="#collapseFive">Specific conductance</a>
                    </h3>
                </div>
            ...
            <div class="card">
                <div class="card-header" role="tab" id="headingSix">
                    <h3 class="heading mb-0">
                        <a class="collapsed" data-toggle="collapse" data-parent="#accordian" href="#collapseSix">Turbidity</a>
                    </h3>
                </div>
            ...
            <div class="card">
                <div class="card-header" role="tab" id="headingSeven">
                    <h3 class="heading mb-0">
                        <a class="collapsed" data-toggle="collapse" data-parent="#accordian" href="#collapseSeven">Herbicides</a>
                    </h3>
                </div>
            ...
            <div class="card">
                <div class="card-header" role="tab" id="headingEight">
                    <h3 class="heading mb-0">
                        <a class="collapsed" data-toggle="collapse" data-parent="#accordian" href="#collapseEight">Nitrate and Nitrite</a>
                    </h3>
                </div>
            ...
            <div class="card">
                <div class="card-header" role="tab" id="headingNine">
                    <h3 class="heading mb-0">
                        <a class="collapsed" data-toggle="collapse" data-parent="#accordian" href="#collapseNine">Total Phosphorus</a>
                    </h3>
                </div>
            ...
            <div class="card">
                <div class="card-header" role="tab" id="headingTen">
                    <h3 class="heading mb-0">
                        <a class="collapsed" data-toggle="collapse" data-parent="#accordian" href="#collapseTen">E. coli</a>
                    </h3>
                </div>
