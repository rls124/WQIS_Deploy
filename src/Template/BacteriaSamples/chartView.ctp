...
<div class = "container roundGreyBox">
    <p class="centeredText" id="wqisHeading" style='font-size:2.5rem;'><span class="glyphicon glyphicon-stats" style="font-size: 20pt;"></span>  Bacteria Charting
	...
	<?= $this->Form->create('chartselection', ['url' => ['controller' => 'BacteriaSamples', 'action' => 'measureview'], 'id' => 'chartSelect']) ?>
    <br/>
